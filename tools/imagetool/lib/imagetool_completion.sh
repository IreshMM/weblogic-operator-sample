...
function _picocli_imagetool_create() {
  ...
  local commands=""
  local flag_opts="--skipcleanup --dryRun --pull --latestPSU --recommendedPatches --strictPatchOrdering --skipOpatchUpdate --wdtRunRCU --wdtModelOnly --wdtStrictValidation"
  local arg_opts="--tag --fromImage --httpProxyUrl --httpsProxyUrl --chown --additionalBuildCommands --additionalBuildFiles --buildNetwork --packageManager --builder -b --target --build-arg --platform --user --password --passwordEnv --passwordFile --patches --opatchBugNumber --type --version --jdkVersion --installerResponseFile --inventoryPointerFile --inventoryPointerInstallLoc --wdtModel --wdtArchive --wdtVariables --wdtVersion --wdtModelHome --wdtHome --wdtDomainType --wdtDomainHome --wdtJavaOptions --wdtEncryptionKey --wdtEncryptionKeyEnv --wdtEncryptionKeyFile --resourceTemplates"
  ...
  local installerType_option_args=("WLS" "WLSSLIM" "WLSDEV" "FMW" "OSB" "SOA" "SOA_OSB" "SOA_OSB_B2B" "MFT" "IDM" "IDM_WLS" "OAM" "OIG" "OUD" "OUD_WLS" "OID" "WCC" "WCP" "WCS" "OHS" "OHS_DB19" "ODI") # --type values
...
function _picocli_imagetool_createAuxImage() {
  ...
  local commands=""
  local flag_opts="--skipcleanup --dryRun --pull"
  local arg_opts="--tag --fromImage --httpProxyUrl --httpsProxyUrl --chown --additionalBuildCommands --additionalBuildFiles --buildNetwork --packageManager --builder -b --target --build-arg --platform --wdtModel --wdtArchive --wdtVariables --wdtVersion --wdtModelHome --wdtHome"
  local package_manager_option_args=("OS_DEFAULT" "NONE" "YUM" "DNF" "MICRODNF" "MICRODNF_8" "APTGET" "APK" "ZYPPER") # --packageManager values
  local target_environment_option_args=("Default" "OpenShift") # --target values
...
function _picocli_imagetool_update() {
  ...
  local commands=""
  local flag_opts="--skipcleanup --dryRun --pull --latestPSU --recommendedPatches --strictPatchOrdering --skipOpatchUpdate --wdtRunRCU --wdtModelOnly --wdtStrictValidation"
  local arg_opts="--tag --fromImage --httpProxyUrl --httpsProxyUrl --chown --additionalBuildCommands --additionalBuildFiles --buildNetwork --packageManager --builder -b --target --build-arg --platform --user --password --passwordEnv --passwordFile --patches --opatchBugNumber --type --wdtOperation --wdtModel --wdtArchive --wdtVariables --wdtVersion --wdtModelHome --wdtHome --wdtDomainType --wdtDomainHome --wdtJavaOptions --wdtEncryptionKey --wdtEncryptionKeyEnv --wdtEncryptionKeyFile --resourceTemplates"
  local package_manager_option_args=("OS_DEFAULT" "NONE" "YUM" "DNF" "MICRODNF" "MICRODNF_8" "APTGET" "APK" "ZYPPER") # --packageManager values
  local target_environment_option_args=("Default" "OpenShift") # --target values
  local installerType_option_args=("WLS" "WLSSLIM" "WLSDEV" "FMW" "OSB" "SOA" "SOA_OSB" "SOA_OSB_B2B" "MFT" "IDM" "IDM_WLS" "OAM" "OIG" "OUD" "OUD_WLS" "OID" "WCC" "WCP" "WCS" "OHS" "OHS_DB19" "ODI") # --type values
...
function _picocli_imagetool_rebase() {
  ...
  local commands=""
  local flag_opts="--skipcleanup --dryRun --pull --latestPSU --recommendedPatches --strictPatchOrdering --skipOpatchUpdate"
  local arg_opts="--tag --fromImage --httpProxyUrl --httpsProxyUrl --chown --additionalBuildCommands --additionalBuildFiles --buildNetwork --packageManager --builder -b --target --build-arg --platform --user --password --passwordEnv --passwordFile --patches --opatchBugNumber --type --version --jdkVersion --installerResponseFile --inventoryPointerFile --inventoryPointerInstallLoc --sourceImage --targetImage"
  local package_manager_option_args=("OS_DEFAULT" "NONE" "YUM" "DNF" "MICRODNF" "MICRODNF_8" "APTGET" "APK" "ZYPPER") # --packageManager values
  local target_environment_option_args=("Default" "OpenShift") # --target values
  local installerType_option_args=("WLS" "WLSSLIM" "WLSDEV" "FMW" "OSB" "SOA" "SOA_OSB" "SOA_OSB_B2B" "MFT" "IDM" "IDM_WLS" "OAM" "OIG" "OUD" "OUD_WLS" "OID" "WCC" "WCP" "WCS" "OHS" "OHS_DB19" "ODI") # --type values
